...
<section class="bg-secondary vw-100 vh-100 flex flex-direction-col page-pad">
	...
	<div class="bg-primary vw-100 h-fit template-form-bg flex flex-direction-col flex-gap-large" id="form-login">
		<div class="flex flex-direction-col flex-gap-semi-large">
			...
			<div class="flex flex-direction-col flex-gap-regular">
				<div class="head-input-secondary">Vehicle Fuel (liter)</div>
				<input type="text" name="" class="input-field w-100" placeholder="input vehicle fuel.." bind:value={vehicle_fuel}>
			</div>
			<div class="flex flex-direction-col flex-gap-regular">
			...
			<div class="flex flex-direction-col flex-gap-semi-large padding-btn-login">
				<button class="btn-secondary w-100" on:click={() => {
					if (home_electricity == "" || home_electricity == null) {
					...
					} else if(vehicle_fuel == "" || vehicle_fuel == null) {
						messageModal = 1;
						messagePayload = "Please fill your vehicle fuel";
						...
						real_vehicle_fuel = Math.round(vehicle_fuel * 2.3);
						...
						carbon_total = real_home_electricity+real_kitchen_gas+real_vehicle_fuel+real_meat_consumption+real_vegetable_consumption+real_water_usage+real_garbage_disposal+real_airplane_flight;
						...
						setCarbonData(real_home_electricity, real_kitchen_gas, real_vehicle_fuel, real_meat_consumption, real_vegetable_consumption, real_water_usage, real_garbage_disposal, real_airplane_flight,carbon_total,carbon_level);
